											...
											<td align="center" valign="top" height="10" style="border-collapse:collapse;color:#525252"></td>
												...
												<table width="100%" valign="top" border="0" cellpadding="0" cellspacing="0" dir="rtl"> <tbody><tr>
														...
														<td width="100%" style="font-size:8pt;border-collapse:collapse;color:#525252;padding:10px;background-color:rgb(255,255,255);border-color:#e8e8e8;border-width:1px;border-radius:5px;border-style:solid;font-size:8pt;padding:15px 40px!important" align="left" valign="top"> <center>
																<a href="{{ url('/') }}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank"> {{ trans('front.home_page') }} </a>
																&nbsp; |&nbsp;&nbsp;
																<a href="{{ url('/products') }}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank"> {{ trans('front.products') }} </a>
																&nbsp; |&nbsp;&nbsp;
																<a href="{{ url('/pages/persian_about_page') }}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank"> {{ trans('front.about') }} </a>
																&nbsp; |&nbsp;
																<a href="{{ url('/contact') }}" style="color:#999;text-decoration:none;font-family:Tahoma;font-size:8pt" target="_blank"> {{ trans('front.contact_us') }}</a>
															</center>
														</td>
													</tr>
													</tbody>
